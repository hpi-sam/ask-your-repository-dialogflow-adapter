...
fs.writeFile('./autogenerated_GetArtifactsNoTeamSelected_usersays_en.json', gen.makePhrases(), (err) => {
  if (err) { console.error(err); }
});

gen = new PhraseGenerator([new AuthorSuffix(), new DateSuffix(), new TagSuffix()]);
fs.writeFile('./autogenerated_GetArtifacts_usersays_en.json', gen.makePhrases(), (err) => {
  if (err) { console.error(err); }
});